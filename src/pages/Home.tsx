...
function Home() {
  return (
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-white bg-black pt-20 md:pt-0">
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start text-center md:text-left px-4 max-w-5xl py-12 md:py-0">
          ...
          <div className="md:flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 md:mb-6 text-white">Meeraj Ahmad Gonnuru</h2>
            <p className="text-xl md:text-2xl mb-6 md:mb-8 text-gray-300">Data Scientist / Data Analyst</p>
            ...
            <div className="space-x-2 md:space-x-4">
              <a 
                ...
                className="bg-gray-800 hover:bg-gray-700 text-white px-4 md:px-8 py-2 md:py-3 rounded-lg transition duration-300 text-sm md:text-base"
              >
                Download Resume
              </a>
              <Link 
                to="/contact" 
                className="bg-white/20 hover:bg-white/30 text-white px-4 md:px-8 py-2 md:py-3 rounded-lg transition duration-300 text-sm md:text-base"
              >
                Contact Me
              </Link>
            </div>
      ...
      <section className="py-16 bg-gray-950 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link 
            to="/projects" 
            className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition duration-300"
          >
            View All Projects
      ...
      <section className="py-16 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-12">
            <a href="mailto:meerajahmadgonnuru@gmail.com" className="flex items-center gap-2 hover:text-gray-400 transition duration-300">
              <Mail className="w-6 h-6" />
              meerajahmadgonnuru@gmail.com
            </a>
            <a href="tel:+919502553535" className="flex items-center gap-2 hover:text-gray-400 transition duration-300">
