...
var u2 = (c, n, i) => n in c ? t0(c, n, { enumerable: true, configurable: true, writable: true, value: i }) : c[n] = i;
var F = (c, n) => {
  for (var i in n || (n = {}))
    e3.call(n, i) && u2(c, i, n[i]);
  if (k1)
    for (var i of k1(n))
...
var O1 = (c, n) => {
  var i = {};
  for (var s in c)
    e3.call(c, s) && n.indexOf(s) < 0 && (i[s] = c[s]);
  if (c != null && k1)
    for (var s of k1(c))
      n.indexOf(s) < 0 && t3.call(c, s) && (i[s] = c[s]);
  return i;
};
...
var r0 = (() => {
  ...
  return function(i = {}) {
    var s, d = i, m, b, M = new Promise((e, t) => {
      m = e, b = t;
    }), P = Object.assign({}, d), R = "./this.program", O = "", d1;
    typeof document != "undefined" && document.currentScript && (O = document.currentScript.src), c && (O = c), O.startsWith("blob:") ? O = "" : O = O.substr(0, O.replace(/[?#].*/, "").lastIndexOf("/") + 1), d1 = (e) => fetch(e, { credentials: "same-origin" }).then((t) => t.ok ? t.arrayBuffer() : Promise.reject(Error(t.status + " : " + t.url)));
    ...
    function T2(e, t, r) {
      return p3(e).then((a) => WebAssembly.instantiate(a, t)).then(r, (a) => {
    ...
    var J1 = (e) => {
      throw new y(e.ua.xa.va.name + " instance already deleted");
    }, G1 = false, D2 = () => {
    }, k2 = (e, t, r) => t === r ? e : r.Aa === void 0 ? null : (e = k2(e, t, r.Aa), e === null ? null : r.Ua(e)), O2 = {}, g3 = {}, y3 = (e, t) => {
      if (t === void 0)
      ...
      return t.count = { value: 1 }, m1(Object.create(e, { ua: { value: t, writable: true } }));
    }, m1 = (e) => typeof FinalizationRegistry == "undefined" ? (m1 = (t) => t, e) : (G1 = new FinalizationRegistry((t) => {
      t = t.ua, --t.count.value, t.count.value === 0 && (t.za ? t.Ba.Ea(t.za) : t.xa.va.Ea(t.wa));
    }), m1 = (t) => {
      var r = t.ua;
      return r.za && G1.register(t, { ua: r }, t), t;
    }, D2 = (t) => {
      G1.unregister(t);
    }, m1(e));
    function x1() {
    }
    var _1 = (e, t) => Object.defineProperty(t, "name", { value: e }), z2 = (e, t, r) => {
      if (e[t].ya === void 0) {
        var a = e[t];
        e[t] = function(...o) {
          if (!e[t].ya.hasOwnProperty(o.length))
            throw new y(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].ya})!`);
          return e[t].ya[o.length].apply(this, o);
        }, e[t].ya = [], e[t].ya[a.Ha] = a;
      }
    }, q1 = (e, t, r) => {
      if (d.hasOwnProperty(e)) {
        if (r === void 0 || d[e].ya !== void 0 && d[e].ya[r] !== void 0)
          throw new y(`Cannot register public name '${e}' twice`);
        if (z2(d, e, e), d[e].ya.hasOwnProperty(r))
    ...
    function L3(e, t, r, a, o, u, h, l) {
      this.name = e, this.constructor = t, this.Ga = r, this.Ea = a, this.Aa = o, this.Wa = u, this.Ka = h, this.Ua = l, this.cb = [];
    }
    var K1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.Ka)
    ...
    function C3(e, t) {
      ...
      return K1(t.ua.wa, t.ua.xa.va, this.va);
    }
    function M3(e, t) {
      if (t === null) {
        if (this.Na)
        ...
        if (this.Ma) {
          var r = this.Oa();
          return e !== null && e.push(this.Ea, r), r;
        }
        return 0;
      }
      if (!t || !t.ua)
      ...
      if (!t.ua.wa)
        throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.La && t.ua.xa.La)
        throw new y(`Cannot convert argument of type ${t.ua.Ba ? t.ua.Ba.name : t.ua.xa.name} to parameter type ${this.name}`);
      if (r = K1(t.ua.wa, t.ua.xa.va, this.va), this.Ma) {
        if (t.ua.za === void 0)
        ...
        switch (this.ib) {
          ...
          case 2:
            if (t.ua.Ba === this)
              ...
              var a = t.clone();
              r = this.eb(r, A1(() => a.delete())), e !== null && e.push(this.Ea, r);
            }
            break;
          default:
    ...
    function E3(e, t) {
      ...
      if (!t.ua.wa)
        throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (t.ua.xa.La)
        throw new y(`Cannot convert argument of type ${t.ua.xa.name} to parameter type ${this.name}`);
      return K1(t.ua.wa, t.ua.xa.va, this.va);
    }
    function g1(e, t, r, a, o, u, h, l, p, v, f) {
      this.name = e, this.va = t, this.Na = r, this.La = a, this.Ma = o, this.bb = u, this.ib = h, this.Sa = l, this.Oa = p, this.eb = v, this.Ea = f, o || t.Aa !== void 0 ? this.toWireType = M3 : (this.toWireType = a ? C3 : E3, this.Da = null);
    }
    var W2 = (e, t, r) => {
      if (!d.hasOwnProperty(e))
        throw new f1("Replacing nonexistent public symbol");
      d[e].ya !== void 0 && r !== void 0 ? d[e].ya[r] = t : (d[e] = t, d[e].Ha = r);
    }, j, P3 = (e, t, r = []) => (e.includes("j") ? (e = e.replace(/p/g, "i"), t = (0, d["dynCall_" + e])(t, ...r)) : t = j.get(t)(...r), t), I3 = (e, t) => (...r) => P3(e, t, r), z = (e, t) => {
      e = D(e);
      var r = e.includes("j") ? I3(e, t) : j.get(t);
    ...
    function X1(e, t, r, a, o) {
      ...
      var h = t[1] !== null && r !== null, l = S3(t), p = t[0].name !== "void", v = u - 2, f = Array(v), w = [], L = [];
      return _1(e, function(...U) {
        if (L.length = 0, w.length = h ? 2 : 1, w[0] = o, h) {
          var I = t[1].toWireType(L, this);
          w[1] = I;
        }
        for (var T = 0; T < v; ++T)
        ...
        if (U = a(...w), l)
          ...
          for (T = h ? 1 : 2; T < t.length; T++) {
            var N = T === 1 ? I : f[T - 2];
            t[T].Da !== null && t[T].Da(N);
          }
        return I = p ? t[0].fromWireType(U) : void 0, I;
      });
    }
    var B2 = (e) => {
      e = e.trim();
      ...
      var t = e2(e);
      return Q1(e), t;
    }, toWireType: (e, t) => A1(t), Ca: 8, readValueFromPointer: v1, Da: null }, T3 = (e, t, r) => {
      switch (t) {
        case 1:
          return r ? function(a) {
    ...
    }, A3 = Object.assign({ optional: true }, j2), H2 = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, R3 = (e, t) => {
    ...
    R2 = q22, y = d.BindingError = class extends Error {
      ...
      if (!(this instanceof x1 && e instanceof x1))
        return false;
      var t = this.ua.xa.va, r = this.ua.wa;
      e.ua = e.ua;
      var a = e.ua.xa.va;
      for (e = e.ua.wa; t.Aa; )
        r = t.Ka(r), t = t.Aa;
      ...
      if (this.ua.wa || J1(this), this.ua.Ja)
        return this.ua.count.value += 1, this;
      var e = m1, t = Object, r = t.create, a = Object.getPrototypeOf(this), o = this.ua;
      return e = e(r.call(t, a, { ua: { value: { count: o.count, Ia: o.Ia, Ja: o.Ja, wa: o.wa, xa: o.xa, za: o.za, Ba: o.Ba } } })), e.ua.count.value += 1, e.ua.Ia = false, e;
    }, delete() {
      if (this.ua.wa || J1(this), this.ua.Ia && !this.ua.Ja)
        throw new y("Object already scheduled for deletion");
      D2(this);
      var e = this.ua;
      --e.count.value, e.count.value === 0 && (e.za ? e.Ba.Ea(e.za) : e.xa.va.Ea(e.wa)), this.ua.Ja || (this.ua.za = void 0, this.ua.wa = void 0);
    }, isDeleted: function() {
      return !this.ua.wa;
    }, deleteLater: function() {
      if (this.ua.wa || J1(this), this.ua.Ia && !this.ua.Ja)
        throw new y("Object already scheduled for deletion");
      return this.ua.Ia = true, this;
    } }), Object.assign(g1.prototype, { Xa(e) {
      return this.Sa && (e = this.Sa(e)), e;
    }, Qa(e) {
      var t;
      (t = this.Ea) == null || t.call(this, e);
    }, Ca: 8, readValueFromPointer: v1, fromWireType: function(e) {
      function t() {
        return this.Ma ? T1(this.va.Ga, { xa: this.bb, wa: r, Ba: this, za: e }) : T1(this.va.Ga, { xa: this, wa: e });
      }
      var r = this.Xa(e);
      if (!r)
        return this.Qa(e), null;
      var a = y3(this.va, r);
      if (a !== void 0)
        return a.ua.count.value === 0 ? (a.ua.wa = r, a.ua.za = e, a.clone()) : (a = a.clone(), this.Qa(e), a);
      if (a = this.va.Wa(r), a = O2[a], !a)
        return t.call(this);
      a = this.La ? a.Ta : a.pointerType;
      var o = k2(r, this.va, a.va);
      return o === null ? t.call(this) : this.Ma ? T1(a.va.Ga, { xa: a, wa: o, Ba: this, za: e }) : T1(a.va.Ga, { xa: a, wa: o });
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var V3 = { c: (e, t, r, a) => P1(`Assertion failed: ${e ? c1(x, e) : ""}, at: ` + [t ? t ? c1(x, t) : "" : "unknown filename", r, a ? a ? c1(x, a) : "" : "unknown function"]), m: (e, t, r) => {
      var a = new f3(e);
      throw E[a.wa + 16 >> 2] = 0, E[a.wa + 4 >> 2] = t, E[a.wa + 8 >> 2] = r, A2 = e, A2;
    }, M: () => {
    }, J: () => {
    }, K: () => {
    }, P: function() {
      ...
      var t = I1[e];
      delete I1[e];
      var r = t.Oa, a = t.Ea, o = t.Ra, u = o.map((h) => h.$a).concat(o.map((h) => h.gb));
      Q([e], u, (h) => {
        var l = {};
        return o.forEach((p, v) => {
          var f = h[v], w = p.Ya, L = p.Za, U = h[v + o.length], I = p.fb, T = p.hb;
          l[p.Va] = { read: (N) => f.fromWireType(w(L, N)), write: (N, w1) => {
            var B = [];
            I(T, N, U.toWireType(B, w1)), V1(B);
          } };
        ...
        }, Ca: 8, readValueFromPointer: v1, Da: a }];
      });
    }, C: () => {
    }, W: (e, t, r, a) => {
      t = D(t), H(e, { name: t, fromWireType: function(o) {
        ...
        return u ? r : a;
      }, Ca: 8, readValueFromPointer: function(o) {
        return this.fromWireType(x[o]);
      }, Da: null });
    }, r: (e, t, r, a, o, u, h, l, p, v, f, w, L) => {
      f = D(f), u = z(o, u), l && (l = z(h, l)), v && (v = z(p, v)), L = z(w, L);
      var U = b3(f);
      q1(U, function() {
        ...
        I = _1(f, function(...d2) {
          ...
          var Q2 = B.Fa[d2.length];
          if (Q2 === void 0)
            throw new y(`Tried to invoke ctor of ${f} with invalid number of parameters (${d2.length}) - expected (${Object.keys(B.Fa).toString()}) parameters instead!`);
          return Q2.apply(this, d2);
        });
        var w1 = Object.create(N, { constructor: { value: I } });
        I.prototype = w1;
        var B = new L3(f, I, w1, L, T, u, l, v);
        if (B.Aa) {
          var b1;
          (b1 = B.Aa).Pa != null || (b1.Pa = []), B.Aa.Pa.push(B);
        }
        return T = new g1(f, B, true, false, false), b1 = new g1(f + "*", B, false, false, false), N = new g1(f + " const*", B, false, true, false), O2[e] = { pointerType: b1, Ta: N }, W2(U, I), [T, b1, N];
      });
    }, q: (e, t, r, a, o, u) => {
      var h = Y1(t, r);
      o = z(a, o), Q([], [e], (l) => {
        ...
        if (l.va.Fa === void 0 && (l.va.Fa = []), l.va.Fa[t - 1] !== void 0)
        ...
        }, Q([], h, (v) => (v.splice(1, 0, null), l.va.Fa[t - 1] = X1(p, v, null, o, u), [])), [];
      });
    }, f: (e, t, r, a, o, u, h, l) => {
      var p = Y1(r, a);
      t = D(t), t = B2(t), u = z(o, u), Q([], [e], (v) => {
        function f() {
          F1(`Cannot call ${w} due to unbound types`, p);
        }
        v = v[0];
        var w = `${v.name}.${t}`;
        t.startsWith("@@") && (t = Symbol[t.substring(2)]), l && v.va.cb.push(t);
        var L = v.va.Ga, U = L[t];
        return U === void 0 || U.ya === void 0 && U.className !== v.name && U.Ha === r - 2 ? (f.Ha = r - 2, f.className = v.name, L[t] = f) : (z2(L, t, w), L[t].ya[r - 2] = f), Q([], p, (I) => (I = X1(w, I, v, u, h), L[t].ya === void 0 ? (I.Ha = r - 2, L[t] = I) : L[t].ya[r - 2] = I, [])), [];
      });
    }, V: (e) => H(e, j2), x: (e, t, r, a) => {
      function o() {
      }
      t = D(t), o.values = {}, H(e, { name: t, constructor: o, fromWireType: function(u) {
        return this.constructor.values[u];
      }, toWireType: (u, h) => h.value, Ca: 8, readValueFromPointer: T3(t, r, a), Da: null }), q1(t, o);
    }, k: (e, t, r) => {
      var a = t2(e, "enum");
      t = D(t), e = a.constructor, a = Object.create(a.constructor.prototype, { value: { value: r }, constructor: { value: _1(`${a.name}_${t}`, function() {
      }) } }), e.values[r] = a, e[t] = a;
    }, z: (e, t, r) => {
      t = D(t), H(e, { name: t, fromWireType: (a) => a, toWireType: (a, o) => o, Ca: 8, readValueFromPointer: x3(t, r), Da: null });
    }, u: (e, t, r, a, o, u) => {
      var h = Y1(t, r);
      e = D(e), e = B2(e), o = z(a, o), q1(e, function() {
      ...
      H(e, { name: t, fromWireType: o, toWireType: h, Ca: 8, readValueFromPointer: F3(t, r, a !== 0), Da: null });
    }, h: (e, t, r) => {
      function a(u) {
      ...
      r = D(r), H(e, { name: r, fromWireType: a, Ca: 8, readValueFromPointer: a }, { ab: true });
    }, t: (e) => {
      H(e, A3);
    }, aa: (e, t, r, a, o, u, h, l, p, v, f, w) => {
      r = D(r), u = z(o, u), l = z(h, l), v = z(p, v), w = z(f, w), Q([e], [t], (L) => (L = L[0], [new g1(r, L.va, false, false, true, L, a, u, l, v, w)]));
    }, A: (e, t) => {
      t = D(t);
      var r = t === "std::string";
      ...
      if (r = D(r), t === 2)
        var a = R3, o = D3, u = k3, h = (l) => u1[l >> 1];
      else
        t === 4 && (a = O3, o = z3, u = W3, h = (l) => E[l >> 2]);
      ...
      }, Ca: 8, readValueFromPointer: v1, Da(l) {
        X(l);
      } });
    }, w: (e, t, r, a, o, u) => {
      I1[e] = { name: D(t), Oa: z(r, a), Ea: z(o, u), Ra: [] };
    }, j: (e, t, r, a, o, u, h, l, p, v) => {
      I1[e].Ra.push({ Va: D(t), $a: r, Ya: z(a, o), Za: u, gb: h, fb: z(l, p), hb: v });
    }, X: (e, t) => {
      t = D(t), H(e, { jb: true, name: t, Ca: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, H: () => {
      N1 = false, i2 = 0;
      ...
      throw 1 / 0;
    }, _: (e, t, r, a) => (e = r2[e], t = e2(t), e(null, t, r, a)), B: Q1, Z: (e, t, r) => {
      var a = U3(e, t), o = a.shift();
      e--;
      var u = Array(e);
      return t = `methodCaller<(${a.map((h) => h.name).join(", ")}) => ${o.name}>`, $3(_1(t, (h, l, p, v) => {
        for (var f = 0, w = 0; w < e; ++w)
          u[w] = a[w].readValueFromPointer(v + f), f += a[w].Ca;
        return l = r === 1 ? B3(l, u) : l.apply(h, u), h = [], l = o.toWireType(h, l), h.length && (E[p >> 2] = A1(h)), l;
      }));
    }, $: (e) => {
      9 < e && (Y[e + 1] += 1);
    }, Y: (e) => {
      var t = e2(e);
      V1(t), Q1(e);
    }, o: (e, t) => (e = t2(e, "_emval_take_value"), e = e.readValueFromPointer(t), A1(e)), E: (e, t) => {
      if (y1[e] && (clearTimeout(y1[e].id), delete y1[e]), !t)
        return 0;
      var r = setTimeout(() => {
        delete y1[e], j3(() => Y2(e, performance.now()));
      }, t);
      return y1[e] = { id: r, kb: t }, 0;
    }, F: (e, t, r, a) => {
      ...
      for (var o = 0, u = 0; u < r; u++) {
        ...
        t += 8;
        for (var p = 0; p < l; p++) {
          var v = e, f = x[h + p], w = H3[v];
          f === 0 || f === 10 ? ((v === 1 ? L1 : K)(c1(w)), w.length = 0) : w.push(f);
        }
        o += l;
      }
      return E[a >> 2] = o, 0;
    }, i: Y3, d: K3, e: q3, p: X3, y: e0, b: G3, a: J3, g: Q3, n: Z3, S: V2, I: (e, t) => (G2(x.subarray(e, e + t)), 0) }, S = function() {
      var r;
      function e(a) {
        var o;
        return S = a.exports, M1 = S.ca, C22(), j = S.ga, E2.unshift(S.da), t1--, (o = d.monitorRunDependencies) == null || o.call(d, t1), t1 == 0 && (l1 && (a = l1, l1 = null, a())), S;
      }
      t1++, (r = d.monitorRunDependencies) == null || r.call(d, t1);
      var t = { a: V3 };
      ...
      return h1 != null || (h1 = I2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : d.locateFile ? d.locateFile("DotLottiePlayer.wasm", O) : O + "DotLottiePlayer.wasm"), v3(t, function(a) {
        e(a.instance);
      }).catch(b), {};
    }(), s2 = (e) => (s2 = S.ea)(e), K2 = (e) => (K2 = S.fa)(e), X = (e) => (X = S.ha)(e), Y2 = (e, t) => (Y2 = S.ia)(e, t), V = (e, t) => (V = S.ja)(e, t), J = (e) => (J = S.ka)(e), G = () => (G = S.la)();
    d.dynCall_iijj = (e, t, r, a, o, u) => (d.dynCall_iijj = S.ma)(e, t, r, a, o, u), d.dynCall_vijj = (e, t, r, a, o, u) => (d.dynCall_vijj = S.na)(e, t, r, a, o, u), d.dynCall_jiii = (e, t, r, a) => (d.dynCall_jiii = S.oa)(e, t, r, a), d.dynCall_jii = (e, t, r) => (d.dynCall_jii = S.pa)(e, t, r), d.dynCall_viijii = (e, t, r, a, o, u, h) => (d.dynCall_viijii = S.qa)(e, t, r, a, o, u, h), d.dynCall_iiiiij = (e, t, r, a, o, u, h) => (d.dynCall_iiiiij = S.ra)(e, t, r, a, o, u, h), d.dynCall_iiiiijj = (e, t, r, a, o, u, h, l, p) => (d.dynCall_iiiiijj = S.sa)(e, t, r, a, o, u, h, l, p), d.dynCall_iiiiiijj = (e, t, r, a, o, u, h, l, p, v) => (d.dynCall_iiiiiijj = S.ta)(e, t, r, a, o, u, h, l, p, v);
    function J3(e, t, r) {
      var a = G();
      try {
        j.get(e)(t, r);
...
function a3(c) {
  return n3.every((n) => Object.prototype.hasOwnProperty.call(c, n));
}
function f2(c) {
  if (typeof c == "string")
    try {
      return a3(JSON.parse(c));
    } catch (n) {
      return false;
    }
  else
...
function Z() {
  return 1 + ((A ? window.devicePixelRatio : 1) - 1) * i3;
}
function $1(c) {
...
var C = class C2 {
  ...
  setBackgroundColor(n) {
    this._dotLottieCore !== null && (A && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = n : this._dotLottieCore.setConfig(k(F({}, this._dotLottieCore.config()), { backgroundColor: o3(n) })), this._backgroundColor = n);
  }
  setLoop(n) {
...
var U1 = class {
  ...
  getWorker(n) {
    return this._workers.has(n) || this._workers.set(n, new d3()), this._workers.get(n);
  }
...
var q = class q2 {
  constructor(n) {
    ...
    _(this, "_pointerExitMethod");
    var s, d, m;
    this._canvas = n.canvas, this._id = `dotlottie-${l3()}`;
  ...
  _create(n) {
    return g(this, null, function* () {
      ...
      let { instanceId: s } = yield this._sendMessage("create", F({ instanceId: this._id, config: k(F({}, n), { canvas: i }) }, u3(this._canvas, ((d = n.renderConfig) == null ? void 0 : d.devicePixelRatio) || Z())), [i]);
      if (s !== this._id)
  ...
  resize() {
    return g(this, null, function* () {
      if (!this._created)
        return;
      let { height: n, width: i } = u3(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || Z());
  ...
  _sendMessage(n, i, s) {
    return g(this, null, function* () {
      let d = { id: `dotlottie-request-${l3()}`, method: n, params: i };
...
var useDotLottie = (config) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (canvas) {
      dotLottieInstance = new s3(__spreadProps(__spreadValues({}, configRef.current), {
        canvas
      }));
...
var useDotLottieWorker = (config) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    let dotLottieInstance = null;
    if (canvas) {
      dotLottieInstance = new h3(__spreadProps(__spreadValues({}, configRef.current), {
        canvas
      }));
      canvas.addEventListener("mouseenter", hoverHandler);
      canvas.addEventListener("mouseleave", hoverHandler);
